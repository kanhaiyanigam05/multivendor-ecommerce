...
import DiscountCheckoutSwiper from "@/layout/DiscountCheckoutSwiper";
import Link from "next/link";
import React from "react";

const CheckoutPage = () => {
  const { data, total } = useCartModal();
  return (
    <>
      {/* <!-- page-title --> */}
      <div
              ...
              <div className="flat-spacing tf-page-checkout">
                <div className="wrap">
                  <div className="title-login">
                    ...
                    <a href="login.html" className="text-button">
                      Login here
                    </a>
                  </div>
              ...
              <div className="flat-spacing flat-sidebar-checkout">
                <div className="sidebar-checkout-content">
                  ...
                  {/* <div className="sec-discount">
                    ...
                    <p>
                      Discount code is only used for orders with a total value
                      of products over $500.00
                    </p>
                  </div> */}
                  <div className="sec-total-price">
                    ...
                    <div className="bottom">
                      <h5 className="d-flex justify-content-between">
                        <span>Total</span>
                        <span className="total-price-checkout">{`$${total.subtotal}`}</span>
                      </h5>
                    </div>
                  </div>
                </div>
