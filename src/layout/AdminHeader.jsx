            ...
            <div className="col-xl-6 d-none d-xl-block">
              <nav className="box-navigation text-center">
                <ul className="box-nav-ul d-flex align-items-center justify-content-center">
                  <li className={`menu-item ${route === "/" ? "active" : ""}`}>
                  ...
                  >
                    <Link href="/blogs" className="item-link">
                      Blogs
                    ...
                    <div className="sub-menu submenu-default">
                      <ul className="menu-list">
                        <li>
                          <a href="blog-detail.php" className="menu-link-text">
                            Blog Detail
                          </a>
                        </li>
                      </ul>
              ...
              <ul className="nav-icon d-flex justify-content-end align-items-center">
                ...
                <li className="nav-account">
                  ...
                  <div className="dropdown-account dropdown-login">
                    <div className="sub-top">
                      <a href="login.php" className="tf-btn btn-reset">
                        Login
                      </a>
                ...
                <li className="nav-wishlist">
                  <a
                    ...
                    className="nav-icon-item"
                    onClick={() => {
                      dataWishlist.length > 0 && setOpenWishlist(true);
                    }}
                  >
                    <svg
                      className="icon"
                ...
                <li className="nav-cart">
                  <a
                    ...
                    onClick={() => {
                      ...
                      dataCart.length > 0 && !isOpenCart && setOpenCart(true);
                    }}
                  >
                    <svg
                      className="icon"
                    ...
                    <span className="count-box">{dataCart.length}</span>
                  </a>
                </li>
              </ul>
            </div>
